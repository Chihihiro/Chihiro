...
def fund_full_name(fund_id):
    ...
    and is_used=1 AND source not in ('010001','000001','020004','020005','020007') and source not like '03%%' and '04%%' and '05%%'".format(fund_id),engine_base)
    num=len(df)
...
private["same"]= list(map(lambda x,y:  True if y in fund_full_name(x) else False, private["fund_id"], private["private_name"]))


private[["fund_id","private_name"]]( )
...
private["same"]=private[["fund_id","private_name"]].apply(lambda x: x.strip())
