...
def yansuan(JR, source):
    ...
    if df.empty:
        ...
        df2 = pd.read_sql(
            "select fund_id,statistic_date,nav,added_nav from fund_nv_data_source_copy2 where fund_id='{}' and source_id='{}'".format(
                JR, source), engine_base)
