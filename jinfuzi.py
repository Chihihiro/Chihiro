...
import requests
import re
fileobj = open('C:\\Users\\63220\\Desktop\\jfz.txt','r')
try:
...
d.to_csv("C:\\Users\\63220\\Desktop\\SMPPID.txt")
print('done第一步')


# 第二部
# fileobj = open('C:\\Users\\63220\\Desktop\\SMPPID.txt','r')
# try:
#     strings = fileobj.read()
# finally:
#     fileobj.close()
...
uu=[name,result]
d = pd.DataFrame(uu).T
d.to_csv("C:\\Users\\63220\\Desktop\\SMPP4.csv")
print('done')